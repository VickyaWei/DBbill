...
public class Password_Update extends JInternalFrame{
	private Users user1 = LoginFrame.getUser();
	...
	public Password_Update()
	{
		...
		label_4.setText("每个操作员只能修改自己的密码");
		...
		name = new JTextField(user1.getLoginName());
