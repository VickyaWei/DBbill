...
public class Invoice_Chaxun1 extends JInternalFrame{
	...
	public Invoice_Chaxun1(){
		...
		Object[][] re1=getselect1(ConnectDb.getInfo6(0,user.getLoginName()));
		...
		panel1_3.add(button);
		 ...
		 button.addActionListener(new ActionListener(){
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if(name.equals("订单号")){
						Object[][] re2=getselect1(ConnectDb.select5(0,textField_1.getText(),user.getLoginName()));
						model1.setDataVector(re2,columnNames1);
						
					}
					else if(name.equals("发票号")){
						Object[][] re3=getselect1(ConnectDb.select4(0,textField_1.getText(),user.getLoginName()));
		...
		//第二页
			...
			Object[][] re14=getselect1(ConnectDb.getInfo6(1,user.getLoginName()));
			...
			panel2_3.add(button2);
			 ...
			 button2.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						if(name1.equals("订单号")){
							Object[][] re5=getselect1(ConnectDb.select5(1,textField_2.getText(),user.getLoginName()));
							model2.setDataVector(re5,columnNames2);
							
						}
						else if(name1.equals("发票号")){
				            
							Object[][] re6=getselect1(ConnectDb.select4(1,textField_2.getText(),user.getLoginName()));
